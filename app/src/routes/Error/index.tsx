export { AppErrorFallback as ErrorPage } from '@modules/Error/components/AppErrorFallback';
...
//  * It also displays technical details and context in development mode.
//  *
//  * @component
//  * @returns {React.JSX.Element} - The error page UI.
//  *
//  * @example
...
//  * navigate('/error', { state: { error: normalizedError, context: { component: 'Card' } } });
...
//       const normalized = await normalizeError(routerError, location.state?.context);
//       setError(normalized);
//     };
//     loadError();
//   }, [location.state?.context, routerError]);
...
//             <>
//               <h3>Contexte :</h3>
//               <pre>{JSON.stringify(location.state?.context, null, 2)}</pre>
//             </>
//           )}
//         </div>
//       )}
